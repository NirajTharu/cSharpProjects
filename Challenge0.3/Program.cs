// Write the code that processes the contnets of a string array
...
using System;
namespace StringDivision
{
    class Program
    {
        static void Main(string[] args)
        {
            string[] myStrings = new string[2] { "What is your name. I love Sleeping. Write your story", "Why are you here." };
